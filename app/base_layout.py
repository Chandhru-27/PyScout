...
class PyScout(ctk.CTk):
    ...
    - Dashboard with live tracking and stats
    - Management of blocked apps and URLs
    - History and app usage visualization
    - Responsive layout and compact mode
    - Tray icon integration and graceful shutdown
    - Warning and reminder system for user activity
    - Thread management for tracking and reminders
    All major application logic and state transitions are managed here.
    """
